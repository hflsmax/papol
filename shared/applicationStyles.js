...
.board-booklet-spine { position: absolute; z-index: 3; top: 66px; bottom: 8px; left: 0; width: 22px; padding: 0; border: 0; border-radius: 8px; background: transparent; box-shadow: none; pointer-events: auto; cursor: grab; }
...
.board-file-download { display: grid; width: 30px; height: 30px; flex: none; place-items: center; padding: 0; border: 1px solid var(--accent-line); border-radius: 6px; background: var(--accent-soft); box-shadow: none; color: var(--accent); }
.board-file-download:hover, .board-file-download:focus-visible { border-color: var(--accent); background: var(--card); }
.board-file-download .action-glyph { width: 16px; height: 16px; }
...
.board-staging-card { min-width: 0; overflow: hidden; border: 1px solid var(--line); border-radius: var(--radius); background: var(--card); box-shadow: 0 2px 7px rgba(29,33,41,.08); cursor: grab; user-select: none; }
