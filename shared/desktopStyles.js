...
/* The paper or board beside the list is the window's own content, not a
   card on a card: the pane is white and the jacket sits flush in it. The
   board's canvas stays a document window of its own; its jacket here is
   for recognising it, placing what waits for it, and opening it. */
.desktop-detail-pane,
...
.desktop-detail-pane .board-jacket > .panel {
  padding: 0;
  border: 0;
