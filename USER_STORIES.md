...
- **US-7.37** Stepping is **an exploration**, and the page says so from the first step: the card names where I am (*2 of 4 · page 7*) and how to get back — *[ goes back to page 3* — and the pages are framed while it lasts. However many steps I take, the exploration is **one move** in the paper's history: the return pill offers *Back to page 3* and [ takes me there, during the exploration or after it, and ] brings me back to where I had got to (US-7.11).
