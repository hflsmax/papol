...
- **US-7.38** **Leaving never moves the page.** Esc, the card's ×, a press on the page, or another citation all end the exploration where I am, because that is where I am looking; [ is the way back, and the only one. An exploration that ends where it began leaves nothing in the history.
