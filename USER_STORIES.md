...
- **US-7.37** Stepping is **an exploration**, and the page says so from the first step: the card names where I am (*2 of 4 · page 7*) and the pages are framed while it lasts, and ↑ and ↓ on the keyboard step as the card's buttons do. However many steps I take, the exploration is **one move** in the paper's history: the return pill offers *Back to page 3* and [ takes me there, during the exploration or after it, and ] brings me back to where I had got to (US-7.11).
- **US-7.38** **Leaving never moves the page.** Esc, the card's ×, a press on the page, or another citation all end the exploration where I am, because that is where I am looking. The way back is **Back** on the card, beside ↑ and ↓, which returns me to where the exploration began and puts the card away — as [ does, during the exploration or after it. An exploration that ends where it began leaves nothing in the history.
