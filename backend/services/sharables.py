...
*rich* link carries the reading: the PDF with this reader's notes, ink and
clips on it. It is theirs — it sits on their paper page, and only they can
take their marks out of it or close it. A *lean* link carries the PDF alone,
and is nobody's: one per edition, handed to whoever asks, naming no reader
and implying none. Nothing about it is reported back to the reader who first
