...
.board-chapter.collection::after { display: block; z-index: -1; top: 76px; bottom: 0; left: 0; width: auto; height: auto; border: 1px dashed var(--line-strong); border-radius: 14px; background: transparent; }
...
.board-chapter.collection .board-chapter-spine { inset: 76px 0 0; width: auto; border-radius: 14px; cursor: grab; }
